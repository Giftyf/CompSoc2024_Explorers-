...
from compsoc.voting_rules.Consensus import findNConsensus
from compsoc.voting_rules.greedy import greedy_rule
...
def evaluate_voting_rules(num_candidates: int,
    ...
    findNConsensus.__name__="Consensus"
    greedy_rule.__name__="greedy"


    rules = [borda_rule, copeland_rule, dowdall_rule, simpson_rule, findNConsensus, greedy_rule]
